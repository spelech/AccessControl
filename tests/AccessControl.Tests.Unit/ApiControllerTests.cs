...
public class ApiControllerTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    public async Task McpServer_ToolsList_ReturnsAllSixTools()
    {
        ...
        Assert.Contains("accesscontrol__list_doors", tools);
        Assert.Contains("accesscontrol__unlock_door", tools);
        Assert.Contains("accesscontrol__lock_door", tools);
        Assert.Contains("accesscontrol__create_guest_pin", tools);
        Assert.Contains("accesscontrol__revoke_user", tools);
        Assert.Contains("accesscontrol__get_access_logs", tools);
    }
