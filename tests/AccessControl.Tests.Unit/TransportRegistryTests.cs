...
public class TransportRegistryTests
{
    private class FakeLockTransport : ILockTransport
    {
        ...
        public Task<AccessControl.Core.Models.LockState> GetLockStateAsync(string deviceTarget, CancellationToken ct = default) => Task.FromResult(AccessControl.Core.Models.LockState.Locked);
        ...
        public Task<IReadOnlyList<AccessControl.Core.DTOs.HardwareSlotDto>> GetUserCodesAsync(string deviceTarget, CancellationToken ct = default) =>
            Task.FromResult<IReadOnlyList<AccessControl.Core.DTOs.HardwareSlotDto>>(Array.Empty<AccessControl.Core.DTOs.HardwareSlotDto>());
    }
