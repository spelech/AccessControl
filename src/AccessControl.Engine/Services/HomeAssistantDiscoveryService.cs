...
public class HomeAssistantDiscoveryService : IHomeAssistantDiscoveryService
{
    ...
    public HomeAssistantDiscoveryService(string discoveryPrefix = "homeassistant", string statePrefix = "accesscontrol")
    {
    ...
    public string BuildEventDiscoveryTopic(AccessPoint door) =>
        $"{_discoveryPrefix}/event/accesscontrol_{door.Id}/config";
    ...
    public string BuildEventDiscoveryPayload(AccessPoint door)
    {
        ...
        var payload = new
        {
            ...
            unique_id = $"accesscontrol_{door.Id}_access",
    ...
    public string BuildLockDiscoveryTopic(AccessPoint door) =>
        $"{_discoveryPrefix}/lock/accesscontrol_{door.Id}/config";
    ...
    public string BuildLockDiscoveryPayload(AccessPoint door)
    {
        ...
        var payload = new
        {
            discovery_topic = topic,
            name = door.Name,
            unique_id = $"accesscontrol_{door.Id}_lock",
    ...
    public string BuildSensorDiscoveryTopic(AccessPoint door) =>
        $"{_discoveryPrefix}/binary_sensor/accesscontrol_{door.Id}/config";
    ...
    public string BuildSensorDiscoveryPayload(AccessPoint door)
    {
        ...
        {
            discovery_topic = topic,
            name = $"{door.Name} Door Sensor",
            unique_id = $"accesscontrol_{door.Id}_sensor",
    ...
    public string BuildAutoLockSwitchDiscoveryTopic(AccessPoint door) =>
        $"{_discoveryPrefix}/switch/accesscontrol_{door.Id}/config";
    ...
    public string BuildAutoLockSwitchDiscoveryPayload(AccessPoint door)
    {
        ...
        var payload = new
        {
            ...
            unique_id = $"accesscontrol_{door.Id}_autolock",
    ...
    private static object BuildDeviceObject(AccessPoint door)
    {
        return new
        {
            identifiers = new[] { $"accesscontrol_{door.Id}" },
            name = door.Name,
            manufacturer = "AccessControl",
